    ...
    <nav className="bg-gradient-to-r from-blue-600 to-indigo-600 p-4 text-white shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <Link to="/" className="text-2xl font-bold font-satisfy text-yellow-300">
            Home
          </Link>
          <Link to="/create" className="text-2xl font-bold font-satisfy text-yellow-300">
            Create Event
          </Link>
          {user ? (
            ...
            <Link to="/login" className="text-2xl font-bold font-satisfy text-yellow-300">
